...
from shizuka import OWNER_ID, pgram, arq
from shizuka.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from shizuka.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("🔐 ᴍᴏʀᴇ ʜᴇʟᴘ.", url=f"t.me/MissAqsa_bot?start=help"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/41aa5e5bb3dcdc95342fd.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("🔐 ᴍᴀɪɴ ʙᴏᴛ", url="https://t.me/MissAqsa_bot?start=help"),
        InlineKeyboardButton("🔄 ɢᴏ ɪɴʟɪɴᴇ", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[ᴀǫsᴀ ʀᴏʙᴏᴛ⚡](t.me/MissAqsa_bot):**
**MainBot:** `{bot_state}`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [OWNER](t.me/YoungFaiz)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
