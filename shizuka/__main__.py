...
from shizuka.modules import ALL_MODULES
from shizuka.modules.helper_funcs.chat_status import is_user_admin
from shizuka.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
 ──『[ᴀǫsᴀ ʀᴏʙᴏᴛ](https://telegra.ph/file/41aa5e5bb3dcdc95342fd.jpg)』

*ʜᴇʟʟᴏ ʙᴜᴅᴅʏ ❣️ !*
✪ ɪ ᴀᴍ sʜɪᴢᴜᴋᴀ sᴜᴘᴇʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ ᴜsᴇғᴜʟʟ ғᴇᴀᴛᴜʀᴇ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀs ʙᴜᴅᴅʏ 😔
────────────────────────
× *sʜɪᴢᴜᴋᴀ ɪs ᴀ ɴᴀᴍᴇ ᴏғ sᴜᴄᴄᴇss ᴀ ᴘᴏᴡᴇʀғᴜʟʟ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ*
× *ғɪʀsᴛ ᴛᴇʟᴇɢʀᴀᴍ ʙᴏᴛ ʙᴀsᴇᴅ ᴏɴ sǫʟ ᴀɴᴅ ᴍᴏɴɢᴏᴅʙ ᴅᴀᴛᴀʙsᴀᴇ*
────────────────────────
✪ ʜɪᴛ /help ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ ʙᴜᴅᴅʏ ✌️.
────────────────────────
✪ [CHANNEL](t.me/{UPDATES_CHANNEL}) - [SUPPORT](t.me/{SUPPORT_CHAT})
────────────────────────
✪ ──『*ᴛʜᴀɴᴋs  ғᴏʀ  ᴜsɪɴɢ*』
"""
PMSTART_CHAT = (
    "[ɢᴇᴛ ʙᴜsʏ ʟɪᴠɪɴɢ ᴏʀ ɢᴇᴛ ʙᴜsʏ ᴅʏɪɴɢ!!!](https://telegra.ph/file/41aa5e5bb3dcdc95342fd.jpg)",
    "[ɪ'ᴍ sᴛᴀʀ ʙᴏɪ ᴘʀᴏᴊᴇᴄᴛ](https://telegra.ph/file/e1a3bb987e73c3a066dde.jpg)",
    "[ᴛᴜʀɴ ʏᴏᴜʀ ᴡᴏᴜɴᴅs ɪɴᴛᴏ ᴡɪsᴅᴏᴍ 🔥](https://telegra.ph/file/35e730dea457c85cc367b.mp4)",
    "[ʜᴀʜᴀʜᴀᴀ ɪ ᴀᴍ ᴀǫsᴀ!!!!](https://telegra.ph/file/6eda47c03eaf8b8c26cc4.jpg)",
)
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💌 ᴋɪɴɢ", url="t.me/YoungFaiz"),
    ],
    [
        InlineKeyboardButton(text="💌 ᴏᴡɴᴇʀ", url=f"https://t.me/YoungFaiz"),
        InlineKeyboardButton(text="💌 ɴᴇᴛᴡᴏʀᴋ", url=f"https://t.me/{UPDATES_CHANNEL}"),
    ],
    [
...
────────────────────────
✪ ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀᴇᴘᴏʀᴛ ʙᴜɢs ᴏʀ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴏɴ ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ ᴛʜᴇɴ ғᴇᴇʟ ғʀᴇᴇ ᴛᴏ ʀᴇᴀᴄʜ ᴏᴜᴛ: @{SUPPORT_CHAT} ᴏʀ ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](http://t.me/YoungFaiz)
✪ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ: [(/),(!),(?),(.),(~)](https://telegra.ph/file/a4b421a72f39e6ed158fa.jpg)
...
DONATE_STRING = """ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](t.me/its_star_boi)"""
HELP_IMG = "https://telegra.ph/file/e1a3bb987e73c3a066dde.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("shizuka.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="💌 ᴋɪɴɢ ", url=f"t.me/YoungFaiz"),
                        InlineKeyboardButton(
                            text="😎 ᴜᴘᴅᴀᴛᴇs ", url=f"t.me/{UPDATES_CHANNEL}"
                        ),
                    ]
                ]
            ),
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ* © [ F ᴀ ɪ ᴢ ⋆ ](t.me/YoungFaiz)\n*ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ {} ᴍᴏᴅᴜʟᴇs:*\n".format(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="⬅ Home", callback_data="alexa_back"
                            ),
                        ]
                    ]
                ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                "https://telegra.ph/file/41aa5e5bb3dcdc95342fd.jpg",
                caption="「 ᴀᴡsᴀ 」 ɪs ᴀʟɪᴠᴇ ✌️!\n\nᴍᴀᴅᴇ ᴡɪᴛʜ ❤️ ᴀɴᴅ @YoungFaiz 🤏",
            )
        except Unauthorized:
            LOGGER.warning(
    ...
    if WEBHOOK:
        ...
        LOGGER.info("shizuka is now alive and functioning")
