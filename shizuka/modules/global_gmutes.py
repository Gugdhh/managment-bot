...
import shizuka.modules.sql.global_mutes_sql as sql
from shizuka import dispatcher, OWNER_ID, DEV_USERS,DRAGONS,DEMONS, TIGERS,STRICT_GMUTE
from shizuka.modules.helper_funcs.chat_status import user_admin, is_user_admin
from shizuka.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from shizuka.modules.helper_funcs.filters import CustomFilters
from shizuka.modules.sql.users_sql import get_all_chats
