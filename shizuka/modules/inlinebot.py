...
from shizuka.utils.inlinehelper import *
from shizuka.utils.pluginhelpers import fetch, json_prettify
from shizuka import pgram, OPENWEATHERMAP_ID, TIME_API_KEY, SUPPORT_CHAT
