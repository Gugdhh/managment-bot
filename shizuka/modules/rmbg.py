...
from shizuka import TEMP_DOWNLOAD_DIRECTORY, REM_BG_API_KEY, telethn as tbot
...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.reply(
            "remove.bg API returned Errors. Please report to **@its_star_boi**\n`{}".format(
