...
from telegram import MAX_MESSAGE_LENGTH, InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from telegram.ext import CallbackContext, CommandHandler
from telegram.ext.dispatcher import run_async
from telegram.error import BadRequest
from telegram.utils.helpers import escape_markdown, mention_html

from shizuka import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from shizuka.__main__ import STATS, TOKEN, USER_INFO
import shizuka.modules.sql.userinfo_sql as sql
from shizuka.modules.disable import DisableAbleCommandHandler
from shizuka.modules.sql.global_bans_sql import is_user_gbanned
from shizuka.modules.sql.afk_sql import is_afk, check_afk_status
from shizuka.modules.sql.users_sql import get_user_num_chats
from shizuka.modules.helper_funcs.chat_status import sudo_plus
from shizuka.modules.helper_funcs.extraction import extract_user
from shizuka import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Connecting To Aqsa Server</code>", parse_mode=ParseMode.HTML)

    text = (f"╒═══「<b> Userinfo At Aqsa Server :</b> 」\n"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Power level of this person is 'tigers of alexa'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Star_X_Network/46">What is Ranks</a>]'.format(
            bot.username)
                ...
                [
                  [                  
                       InlineKeyboardButton(
                             text="❤️ ʜᴇᴀʀᴛ ❤️",
                             url=f"https://t.me/Ayraupdates"),
                       InlineKeyboardButton(
                             text="‍‍‍👦 ɢʀᴏᴜᴘ ‍👦",
                             url="https://t.me/ayrabots")
                     ] 
                ]
            ),
        )
