...
from shizuka import BOT_NAME

# By @its_star_boi
from shizuka.resources.IMGEDITOR.edit_1 import (  # pylint:disable=import-error
    black_white,
    box_blur,
    bright,
    g_blur,
...
from shizuka.resources.IMGEDITOR.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from shizuka.resources.IMGEDITOR.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from shizuka.resources.IMGEDITOR.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from shizuka.resources.IMGEDITOR.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
__mod_name__ = "🖼 ᴇᴅɪᴛᴏʀ"
__help__ = """
At [star boi ](t.me/starboihacks369) have some advanced image editing tools inbuilt
