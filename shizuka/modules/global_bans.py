...
import shizuka.modules.sql.global_bans_sql as sql
from shizuka.modules.sql.users_sql import get_user_com_chats
from shizuka import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from shizuka.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from shizuka.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    log_message = (
        ...
        f"<b>Bᴀɴɴᴇᴅ Usᴇʀ Iᴅ:</b> <code>{user_chat.id}</code>\n"
...
def ungban(update: Update, context: CallbackContext):
    ...
    log_message = (
        ...
        f"<b>Uɴʙᴀɴɴᴇᴅ Usᴇʀ Iᴅ:</b> <code>{user_chat.id}</code>\n"
        f"<b>Eᴠᴇɴᴛ Sᴛᴀᴍᴘ:</b> <code>{current_time}</code>")
...
def gbanlist(update: Update, context: CallbackContext):
    ...
    with BytesIO(str.encode(banfile)) as output:
        ...
        update.effective_message.reply_document(
            ...
            caption="here the list of gbanned user's!!!.")
