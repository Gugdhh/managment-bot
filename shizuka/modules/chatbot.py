...
import html
import requests
import shizuka.modules.sql.chatbot_sql as sql
...
from shizuka.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from shizuka import dispatcher, updater, SUPPORT_CHAT, BOT_NAME
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                " {BOT_NAME} ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "{BOT_NAME} ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇ ʙʏ{}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>{BOT_NAME} ᴇɴᴀʙʟᴇᴅ ᴄʜᴀᴛs</b>\n"
    for chat in chats:
        try:
